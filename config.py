...
BOT_TOKEN = os.environ.get("BOT_TOKEN", "7325029227:AAE2ceCcHNA_JRmpqGHnKuY9hTxcY9-z8vI")
...
try:
    ADMINS=[7657218453]
    for x in (os.environ.get("ADMINS", "7657218453").split()):
        ADMINS.append(int(x))
except ValueError:
